...
export default function Aboutus() {
    return (
        <div className="about-page">
                <video src='/videos/Boxing.mp4' autoPlay playsInline muted loop className="about-page-hero"/>
                <div className="about-content">
                    <section className="about-section">
                        <h1 className="about-heading">About Us</h1>
                        <p className="about-paragraph">
                            We at GetFit, have taken a vow to make our clients healthy and happy. We have been winning the battle for the last 10 years when we started our journey. Today our family comprises thousands of members and we are growing every day.
                        </p>
                        <p className="about-paragraph">
